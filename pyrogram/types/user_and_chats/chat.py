...
class Chat(Object):
    ...
    def __init__(
        ...
        *,
        ...
        raw: Optional[
            Union["raw.types.UserFull", "raw.types.ChatFull", "raw.types.ChannelFull"]
        ] = None,
    ):
    ...
    async def add_members(
        self, user_ids: Union[Union[int, str], List[Union[int, str]]], forward_limit: int = 100
